...
import Popover from '@root/Popover';
...
export const BaseSelect = forwardRef(
    (
        ...
        if (!theme) throw new Error('[BaseSelect] theme is required');
        ...
        return (
            <SelectThemeProvider size={size} theme={theme} variant={variant} state={state} formControlTheme={formControlTheme}>
                <div
                    css={{
                        maxWidth: '100%',
                        position: 'relative',
