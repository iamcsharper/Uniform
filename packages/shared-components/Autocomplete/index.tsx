...
import type { InputProps } from '@root/Input';
import {
    BaseSelect,
...
import { Arrow as DefaultArrow } from '@root/Select/components/arrow';
...
>(
    (
        ...
        const { value, setValue, handleInput, onClose, handleChange, selectedOptions, filteredOptions } =
            useAutocomplete({
                multiple,
                options,
                initialSelectedValues,
