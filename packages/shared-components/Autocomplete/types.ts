import { createTagListWithTheme } from '@root/SelectWithTags/TagList';
import { ChangeEvent, FC, ReactNode, RefAttributes } from 'react';

import type { FormControlProps } from '../FormControl/types';
import type { InputProps } from '../Input/types';
import type { BaseSelectProps, FieldProps } from '../Select/types';
...
export type AutocompleteProps = Omit<BaseSelectProps, 'Field' | 'nativeSelect'> &
    ...
    > & {
        ...
        TagList: ReturnType<typeof createTagListWithTheme>;
    };
