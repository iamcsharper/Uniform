...
export const Portal = forwardRef<Element, PortalProps>(
    (
        { getPortalContainer = getDefaultPortalContainer, immediateMount: propsImmediateMount = false, children },
        ref
    ) => {
        const immediateMount = typeof window === 'undefined' ? false : propsImmediateMount;
