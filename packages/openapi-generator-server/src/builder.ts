...
type NumberOptions = PropertyBaseOptions &
    Pick<JSONSchema, 'exclusiveMinimum' | 'exclusiveMaximum' | 'maximum' | 'minimum' | 'multipleOf'>;
...
export const object = (properties: Record<string, PropertyValue>, options: ObjectBaseOptions = {}): SchemaObject => {
